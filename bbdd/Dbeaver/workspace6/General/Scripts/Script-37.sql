...
DROP DATABASE IF EXISTS utilidades;
...
CREATE TABLE `paises` (
  ...
  `pai_iso2` char(2) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `pai_iso3` char(3) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `pai_nome` varchar(80) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  PRIMARY KEY (`pai_id`)
...
CREATE TABLE `provincias` (
  ...
  `pro_nome` varchar(30) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL
